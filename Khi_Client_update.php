...
$id = $_GET['id'];
$SelSql = "SELECT * FROM `client` WHERE id=$id";
	...
	<?php if(isset($fmsg)){ ?><div class="alert alert-danger" role="alert"> <?php echo $fmsg; ?> </div><?php } ?>
		...
		<h2>Update Client</h2><br>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="number" name="project_id"  class="form-control" id="project_id" value="<?php echo $r['project_id']; ?>" placeholder="" />
			    </div>
			</div>
